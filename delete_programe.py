...
class Delete:
    ...
    def delete_file(self):
        ...
        pdf_report_path = os.path.join(total_path, "website_security_report.pdf")
        md_report_path = os.path.join(total_path, "website_security_report.md")
        try:
        ...
        try:
            for a in (Logic1_result_path, GPT_Scanner_result_path, GPT_Scanner_summary_result_path, GPT_HTML_Scanner__summary_result_path, GPT_HTML_Scanner_result_path, Logic4_cookies_result_path, Logic4_storage_result_path, Total_JSON_result_path, Total_TXT_result_path, LLM_JSON_result_path, LLM_TXT_result_path, pdf_report_path, md_report_path):
                if os.path.isfile(a):
                    os.remove(a)
                    print(f"{a}파일 삭제 완료\n")
